...
/**
 * ListResponseOfDisbursementDTO Class Doc Comment
 *
 * @category Class
 * @package  FayaPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListResponseOfDisbursementDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListResponseOfDisbursementDTO';
    ...
    protected static $swaggerTypes = [
        'object' => 'string',
        'data' => '\FayaPay\Model\DisbursementDTO[]',
        'next_cursor' => 'string',
     ...
     * Sets data
     *
     * @param \FayaPay\Model\DisbursementDTO[] $data data
     *
     * @return $this
     */
