 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateRefundRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateRefundRequest';
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateRefundRequest., must be smaller than or equal to 500.');
        }
